...
model.load_weights("best_model_BASE_INC.hd5")
...
chkpt1 = ModelCheckpoint(filepath="ft1_inc_best_model_acc.hd5", monitor='accuracy', verbose=1, save_best_only=True, save_weights_only=False)
chkpt2 = ModelCheckpoint(filepath="ft1_inc_best_model_val_acc.hd5", monitor='val_accuracy', verbose=1, save_best_only=True, save_weights_only=False)
chkpt3 = ModelCheckpoint(filepath="ft1_inc_best_model_val_loss.hd5", monitor='val_loss', verbose=1, save_best_only=True, save_weights_only=False)
...
model = load_model("ft1_inc_best_model_val_acc.hd5")
