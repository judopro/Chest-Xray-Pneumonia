...
model.load_weights("v_best_model_50x4.hd5")
...
filename = "v_finetune_val_acc_{epoch:02d}_{val_accuracy:.2f}.hd5"
...
#cweights = {
#    train_generator.class_indices['NORMAL']:1.0,
#    train_generator.class_indices['PNEUMONIA']:1.33
#}
